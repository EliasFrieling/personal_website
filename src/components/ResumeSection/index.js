        ...
        <ResumeWrapper>
          <TextWrapper>
            ...
            <Description>
              ...
              <br />• Integrated with the Bento platform by connecting to the Language Server
              Protocol and adding support for using variables in queries throughout a notebook
            ...
            <Description>
              ...
              <br />• Displayed live market data to the user by using a WebSocket to receive real
              time market data changes, giving up to date pricing information to users as they use
              the order entry tool
              <br />• Collaborated with a designer, product manager, and future users to build an
              intuitive user experience (UX) utilizing conditional component rendering and
            ...
            <Description>
              ...
              Python scripts running in Amazon Web Services to redact data from resumes in S3
              buckets, automating steps of the recruiting process
            ...
            <Description>
              • Imported data from an API to an internal data tool allowing for broad visualization
              of stock market data and documented the steps of how to import various file types
              allowing easier use of the data tool
